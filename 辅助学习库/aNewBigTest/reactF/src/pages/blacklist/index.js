...
class Blacklist extends PureComponent {
    ...
    hanlefunc(props) {
        ...
        this.state.ismore = -1
        let data = Object.assign({}, this.state.query, { sort: props })
    ...
    getTip () {
        ...
        gzhService.listTip({sort, pageNo, pageSize, paramStr, openId}).then(res => {
            ...
            if (res.code * 1 === 200) {
                ...
                this.state.resultData = resultDatas
                this.setState({
	...
	render() {
        ...
        if (ismore === 2) {
            queryMore = <div className='backlist-more' onClick={() => this.getMore()}>加载更多</div>
        } else if (!ismore) {
